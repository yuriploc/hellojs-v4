...
1. Consultar a [API v3](https://developer.github.com/v3/) do GitHub para verificar quem comentou na issue anterior publicando um link do repositório `hellojs-e02` dentro do prazo

2. Refatore o código do exercício [e02.js](../exercicios/e02/e02-1.js)