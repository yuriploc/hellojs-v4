...
2. Consultar a [API v3](https://developer.github.com/v3/) do GitHub para verificar quem comentou na issue anterior publicando um link do repositório `hellojs-e02` dentro do prazo