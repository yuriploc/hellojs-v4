...
mkdir hellojs-e04
# ou git clone https://github.com/<seu usuário aqui>/hellojs-e04.git
...
- use o sqlitebrowser pra criar um banco de dados chamado **e04.sqlite3** dentro da pasta do projeto
...
- abra o seu knexfile e mude **dev.sqlite3** para **e04.sqlite3**
...
- Crie uma tabela `presenca` [E03](/E03.md) Utilizando o `knex migrate` ou o `dbbrowser`
...
repo: `hellojs-e04`  
issue num: 5  
- A rota salva na tabela `presenca` os usuários que postaram um link para o repo na issue até a data limite (é o primeiro comentário da issue)
